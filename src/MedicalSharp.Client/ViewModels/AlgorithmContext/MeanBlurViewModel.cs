...
namespace MedicalSharp.Client.ViewModels.AlgorithmContext
{
    ...
    /// 均值滤波视图模型
    /// </summary>
    public class MeanBlurViewModel : ScreenBase
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public MeanBlurViewModel(IEventAggregator eventAggregator)
        {
        ...
        public async Task Apply()
        {
            ...
            await Task.Run(() =>
            {
                ...
                //执行算法
                using MeanBlur3D meanBlur = new MeanBlur3D(clContext);
                meanBlur.ExecuteInPlace(inputImage, this.KernelSize);
