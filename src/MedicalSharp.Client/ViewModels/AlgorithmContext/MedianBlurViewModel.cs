...
namespace MedicalSharp.Client.ViewModels.AlgorithmContext
{
    ...
    /// 中值滤波视图模型
    /// </summary>
    public class MedianBlurViewModel : ScreenBase
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public MedianBlurViewModel(IEventAggregator eventAggregator)
        {
        ...
        public async Task Apply()
        {
            ...
            await Task.Run(() =>
            {
                ...
                //执行算法
                using MedianBlur3D medianBlur = new MedianBlur3D(clContext);
                medianBlur.ExecuteInPlace(inputImage);
