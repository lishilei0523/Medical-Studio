    ...
    public class VolumeProtocolViewModel : ScreenBase
    {
        ...
        public KeyValuePair<string, string> SelectedInterpolationMode
        {
            ...
            set
            {
                field = value;
                this.NotifyOfPropertyChange();
                this.VolumeViewModel.InterpolationMode = Enum.Parse<InterpolationMode>(value.Key);
            }
        }
        #endregion
        ...
        protected override async Task OnActivatedAsync(CancellationToken cancellationToken)
        {
            ...
            //插值模式
            this.SelectedInterpolationMode = new KeyValuePair<string, string>(this.VolumeViewModel.InterpolationMode.ToString(), this.VolumeViewModel.InterpolationMode.GetEnumMember());
        ...
        public async Task SaveProtocol()
        {
            ...
            if (result == true)
            {
                RaycastProtocol protocol = new RaycastProtocol
                {
                    ...
                    InterpolationMode = this.VolumeViewModel.InterpolationMode,
        ...
        private void SyncToVolumeViewModel()
        {
            ...
            {
                //在颜色控制点中插值该HU位置的颜色
                Color interpolatedColor = ColorControlPoint.InterpolateColor(sortedColors, alphaControlPoint.HU, this.VolumeViewModel.InterpolationMode);
