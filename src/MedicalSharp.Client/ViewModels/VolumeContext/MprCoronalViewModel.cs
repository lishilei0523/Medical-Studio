...
namespace MedicalSharp.Client.ViewModels.VolumeContext
{
    ...
    public class MprCoronalViewModel : ScreenBase
    {
        ...
        public MprCoronalViewModel(IWindowManager windowManager, IEventAggregator eventAggregator)
        {
            ...
            const string title = "Coronal";
            MPRCamera camera = new MPRCamera();
            MPRInputManager inputManager = new MPRInputManager(camera);
            this.MprViewModel = new MprViewModel(windowManager, eventAggregator, title, camera, MPRPlaneType.Coronal, inputManager);
        ...
        public VolumeData VolumeData
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    this.MprViewModel.Plane = MPRPlane.CreateCoronalPlane(value.Metadata);
                }
            }
        }
        #endregion
