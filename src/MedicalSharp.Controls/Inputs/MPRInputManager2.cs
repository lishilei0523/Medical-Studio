...
namespace MedicalSharp.Controls.Inputs
{
    ...
    /// MPR输入管理器
    /// </summary>
    public class MPRInputManager2 : InputManager
    {
        #region # 字段及构造器
        ...
        /// MPR相机
        /// </summary>
        private readonly MPRCamera2 _camera;

        /// <summary>
        /// 创建输入管理器构造器
        /// </summary>
        public MPRInputManager2(MPRCamera2 camera)
        {
            this._camera = camera;
        }
        ...
        #region 只读属性 - MPR相机 —— MPRCamera2 Camera
        /// <summary>
        /// 只读属性 - MPR相机
        /// </summary>
        public MPRCamera2 Camera
        {
            get => this._camera;
        }
        #endregion
