...
namespace MedicalSharp.Controls.Interfaces
{
    ...
    public interface IPickVoxel
    {
        ...
        bool FindNearestVoxel(Vector2 position, out Vector3 textureCoord, out Vector3 worldPosition, out Vector3i voxelPosition, out short voxelValue, out byte markValue, out Ray ray);
    }
}
