...
namespace MedicalSharp.Inspiration.Algorithms
{
    ...
    public sealed class Sobel3D : IDisposable
    {
        ...
        public Sobel3D(ClContext clContext)
        {
            ...
            this._program = ClProgram.FromFile(this._clContext, "Resources/Kernels/sobel_3d.cl");
            this._kernel = this._program.CreateKernel("sobel_3d");
        }
        ...
        #region 执行Sobel边缘检测 —— void Execute(ClImage3D input, ClImage3D output...
        /// <summary>
        /// 执行Sobel边缘检测
        /// </summary>
        ...
        #region 执行Sobel边缘检测（写回） —— void ExecuteInPlace(ClImage3D image...
        /// <summary>
        /// 执行Sobel边缘检测（写回）
        /// </summary>
