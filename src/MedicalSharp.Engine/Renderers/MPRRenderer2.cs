...
namespace MedicalSharp.Engine.Renderers
{
    ...
    /// MPR渲染器
    /// </summary>
    public class MPRRenderer2 : Renderer
    {
        #region # 字段及构造器
        ...
        public MPRRenderer2(MPRCamera2 camera)
            : base(camera)
        {
        ...
        #region 只读属性 - MPR相机 —— MPRCamera2 MPRCamera
        /// <summary>
        /// 只读属性 - MPR相机
        /// </summary>
        public MPRCamera2 MPRCamera
        {
            get => base.Camera as MPRCamera2;
        }
        ...
        private void InitShaderProgram()
        {
            ...
            this.Program.ReadFragmentShaderFromFile("Shaders/GLSLs/mpr2.frag");
            this.Program.Build();
        }
        #endregion
